...
export const wisconsinLocations: LocationEntry[] = [
  {
    state: "Wisconsin",
    stateSlug: "wisconsin",
    city: "Milwaukee",
    ...
    deliveryOptions: [
      {
        ...
        desc: "Meet your puppy in person at the origin, which suits Milwaukee families already heading to Florida for a winter stretch or a February break."
      },
      {
        title: "Flight Nanny to MKE",
        desc: "A nanny carries your puppy in the cabin and hands her to you at Mitchell baggage claim, about twenty minutes from downtown in normal traffic."
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "We build a backup date into every winter arrival before the first one is booked. If Mitchell is holding traffic or a Florida departure gets pushed, the puppy stays where she is and travels on the next clean window rather than waiting out a delay in an airport. Nobody gains anything by forcing a February travel day."
      },
      {
        question: "Is winter a bad time to bring home a teacup Pomeranian in Wisconsin?",
        answer: "Not at all, and there is a case for it. A puppy arriving in January spends her first weeks indoors on a consistent schedule, which makes house training easier than it is in the middle of a Summerfest week. You will want a sweater, a rinse routine for salted sidewalks, and patience with short outdoor trips."
      },
      {
      ...
      },
      {
        ...
        answer: "No. Every placement is coordinated from Miami Beach, and Milwaukee is a delivery market rather than a second address. That is worth knowing up front, because it means the meeting you are planning is an arrival at Mitchell or a handoff near I-94, not a visit to a building in the Third Ward."
      }
    ]
  }
];
