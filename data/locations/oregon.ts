...
export const oregonLocations: LocationEntry[] = [
  {
    state: "Oregon",
    stateSlug: "oregon",
    city: "Portland",
    ...
    heroTitle: "Teacup Pomeranian Puppies in Portland, Oregon",
    ...
    deliveryOptions: [
      {
        ...
        desc: "Portland families often pair this with a winter trip south, meeting the puppy in Miami Beach and flying home to PDX with the carrier under the seat."
      },
      {
        title: "Flight Nanny Delivery",
        desc: "A nanny carries the puppy in cabin from Miami and hands off at PDX arrivals, usually mid afternoon Pacific, which most Portland workdays can absorb."
      },
      {
    ...
    faq: [
      {
        question: "How does the PDX handoff work if I cannot get away from the office?",
        answer: "Most flight nanny arrivals land in the Pacific afternoon, and the meeting point is the lower level at PDX near baggage claim, a short stop if you time it right. If your day will not bend, someone you authorize in advance can take the handoff, and we confirm the name and the arrival window in writing beforehand."
      },
      {
      ...
      },
      {
        ...
        answer: "No. Every puppy is raised, vet checked, and matched in Miami Beach, and Portland is a metro we serve from there. You get to know the puppy through photos, video, and conversation with us before travel is arranged, and the handoff happens at PDX, at your door by ground transport, or in person in Miami Beach."
      },
      {
      ...
      },
      {
        ...
        answer: "Yes. Flight nanny deliveries land at PDX no matter where in the metro you live, and the westside suburbs are a straightforward run out Highway 26 or down I-5 from there. Ground transport goes directly to a residential address in Beaverton, Hillsboro, Lake Oswego, or anywhere else in the region, with the window confirmed the day before."
      }
    ]
  }
];
