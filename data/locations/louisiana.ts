...
export const louisianaLocations: LocationEntry[] = [
  {
    state: "Louisiana",
    stateSlug: "louisiana",
    city: "New Orleans",
    ...
    deliveryOptions: [
      ...
      },
      {
        ...
        desc: "A nanny carries your puppy in the cabin from Miami to MSY, usually on a morning arrival, with the handoff done inside the terminal."
      },
      {
    ...
    faq: [
      {
        question: "How does a double-coated Pomeranian handle New Orleans humidity?",
        answer: "Better than most people expect, as long as the coat stays dry and the routine stays indoor-first. The trouble in this climate is not heat alone but moisture sitting in the undercoat, which is what turns a light tangle into a mat. Brush to the skin a few times a week, dry fully after baths, and save walks for early morning or after sunset."
      },
      {
        question: "Should I shave my Pomeranian for the summer here?",
        answer: "We advise against it. The double coat reflects sun and slows heat transfer, so a shaved Pom is often hotter and more exposed, and the coat does not always grow back evenly. A thorough undercoat rake during the spring shed pulls far more bulk than clippers do, and it leaves the guard hairs doing their job."
      },
      {
      ...
      },
      {
        ...
        answer: "Parade routes are loud, crowded, and full of things a small dog will try to eat off the ground, so most families leave the puppy home during Mardi Gras. Doorbells, brass bands, and house guests still come through, so we start crate and carrier work early. By the time Twelfth Night arrives, a settled puppy treats the noise as background."
      }
    ]
  }
];
