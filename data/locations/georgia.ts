...
export const georgiaLocations: LocationEntry[] = [
  {
    state: "Georgia",
    stateSlug: "georgia",
    city: "Atlanta",
    ...
    faq: [
      {
        question: "Do you work with Atlanta buyers directly?",
        answer: "Yes. Atlanta is one of our active out-of-state service markets, and we can coordinate the process from inquiry through handoff."
      },
      {
        question: "Can you suggest similar puppies if my first choice is reserved?",
        answer: "Absolutely. We can recommend current alternatives or upcoming options that match the same overall style."
      }
    ]
  },
  {
    ...
    deliveryOptions: [
      {
        ...
        desc: "Some Savannah families make the I-95 run a small trip, meeting the puppy in Miami Beach and driving home over two easy days."
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "This is one quiet advantage of a very small dog. He travels in a soft carrier under an airplane seat or on a car floorboard, which makes leaving Chatham County far simpler than it is with a large breed. Keep his carrier, his records, and a few days of food wherever you keep your own go-bag."
      },
      {
