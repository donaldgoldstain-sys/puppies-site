...
export const utahLocations: LocationEntry[] = [
  {
    state: "Utah",
    stateSlug: "utah",
    city: "Salt Lake City",
    ...
    heroTitle: "Teacup Pomeranian Puppies in Salt Lake City, Utah",
    ...
    deliveryOptions: [
      ...
      },
      {
        ...
        desc: "A nanny holds your puppy in the cabin from Miami Beach and hands him to you inside the SLC terminal, a short drive from anywhere in the valley."
      },
      {
    ...
    faq: [
      {
        question: "Can a teacup Pomeranian really handle Salt Lake City winters?",
        answer: "Better than most tiny breeds, since the Pomeranian carries a double coat. The limit is not cold so much as depth: a four-pound dog cannot wade through unshoveled snow, so a cleared path in the yard matters more than a sweater does. On single-digit mornings, keep the outing short and let the afternoon walk be the longer one."
      },
      {
        question: "Do you have a location in Salt Lake City?",
        answer: "No. We place from Miami Beach and serve Salt Lake City as a delivery and support market, so there is no office, kennel, or showroom here to visit. What you get instead is the same person from the first question through the week after arrival, and a handoff arranged either at SLC or at your own door."
      },
      {
      ...
      },
      {
        ...
        answer: "Less than people expect. A teacup Pomeranian gets most of what it needs from indoor play and two short walks, which is convenient during the weeks when the valley air sits heavy and nobody wants to be out long. On red air days, a hallway and a few toys will genuinely do the job."
      },
      {
        question: "Utah gets fireworks twice in July. Is that a problem?",
        answer: "It is worth preparing for. Between the Fourth and Pioneer Day on the twenty-fourth, most Salt Lake neighborhoods get two rounds of backyard fireworks, and small dogs tend to feel it. An interior room, a fan or television for cover, and a familiar blanket handle most of it. Families who place a puppy in spring have months to settle in first."
      }
    ]
  }
];
